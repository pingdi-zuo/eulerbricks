...
extern void InitSys(uint64_t t);
extern void MakeDivs(void);
extern unsigned searchEulerBrick(CBlockHeader &block);
UniValue generateBlocks(std::shared_ptr<CReserveScript> coinbaseScript, int nGenerate, uint64_t nMaxTries, bool keepScript)
{
    ...
    InitSys(0);                        //  Initialize FirstCol[] & MaxD1
