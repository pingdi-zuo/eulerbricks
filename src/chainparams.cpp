...
{
    const char* pszTimestamp = "2016-09-18 00:00:00 eulerbricks start";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 60 * 60;
        ...
        genesis = CreateGenesisBlock(1505692800, 0xed66a, 0x1e00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // printf("genesis hash: %s)\n", consensus.hashGenesisBlock.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("000000d888b136a4e59e86a3cd70c550968e686e9214c43ce4d2397a47d087f7)"));
        // printf("genesis merkle hash: %s)\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(genesis.hashMerkleRoot == uint256S("fee26eefc849f7b23fc71ce1e416e703a655c9a2bf8e51d5adc60ac04fc53f59"));
        ...
        chainTxData = ChainTxData{
            ...
            1504915200, // * UNIX timestamp of last known number of transactions
