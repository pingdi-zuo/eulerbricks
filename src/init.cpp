...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pingdi-zuo/eulerbricks>";
    const std::string URL_WEBSITE = "<https://sourceforge.net/projects/eulerbricks/>";
        ...
        do {
            try {
...

                {
                    ...
                    if (tip && tip->blockHeader.nTime > GetAdjustedTime() + 2 * 60 * 60) {
